...
// Determine total number of months: finances.length
// Determine var.length finances.length

// I want the end result to be tracking change month on month
// I want a variable to show me what that change is
// a variable for an average
